  ...
  return (
    <article className="flex flex-col gap-4 justify-center" style={{ width: 350 }}>
      ...
      <div className="flex justify-center">
        {type === 'register' && <button className="register-button px-8 py-2 rounded-full text-white font-bold text-sm">S'inscrire</button>}
        {type === 'subscription' && <button className="subscription-button px-8 py-2 rounded-full text-black font-bold text-sm">S'abonner</button>}
      </div>
    </article>
  );
}
